"use strict";
(self["webpackChunkext_react"] = self["webpackChunkext_react"] || []).push([["src_components_signup_Signup_jsx"],{
...
var Signup = function Signup() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.prev = 3;
            _context.next = 6;
            return fetch("https://api.twitterai.workers.dev/register", {
              method: "POST",
              headers: {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "bg-white p-8 py-2  rounded-lg shadow-lg w-full max-w-xs"
    ...
    className: "text-center text-sm text-black mt-4"
...
//# sourceMappingURL=src_components_signup_Signup_jsx.js.map